...
class DuelistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create duelist" do
    assert_difference('Duelist.count') do
      post duelists_url, params: { duelist: { age: @duelist.age, favourite_card: @duelist.favourite_card, image: @duelist.image, name: @duelist.name, user_id: @duelist.user_id } }
    end
  ...
  test "should update duelist" do
    patch duelist_url(@duelist), params: { duelist: { age: @duelist.age, favourite_card: @duelist.favourite_card, image: @duelist.image, name: @duelist.name, user_id: @duelist.user_id } }
